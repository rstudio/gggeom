...
condense_count <- function(x, origin, width, z, w) {
    .Call('ggcomp_condense_count', PACKAGE = 'ggcomp', x, origin, width, z, w)
}

condense_sum <- function(x, origin, width, z, w) {
    .Call('ggcomp_condense_sum', PACKAGE = 'ggcomp', x, origin, width, z, w)
}

condense_moments <- function(x, origin, width, z, w, moments) {
    .Call('ggcomp_condense_moments', PACKAGE = 'ggcomp', x, origin, width, z, w, moments)
}

condense_median <- function(x, origin, width, z, w) {
    .Call('ggcomp_condense_median', PACKAGE = 'ggcomp', x, origin, width, z, w)
}
